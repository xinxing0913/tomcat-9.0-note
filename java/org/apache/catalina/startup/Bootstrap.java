 ...
 *
 * Catalina的启动器
 * 它构造了一个类加载用来加载catalina的类
 * 也就是在catalina.home的server目录下的类
 *
 * 这样做的目的是保证catalina的类对应用程序的类不可见
 *
...
public final class Bootstrap {
    ...
    /**
     * 该静态代码块主要做两件事:
     * 1.首先确定家目录，即tomcat的安装目录，即catalina.home
     * 2.然后确定基目录，即tomcat的启动目录，即catalina.base
     */
    static {
    ...
    */
     ...
     *
     * 从ExceptionUtils拷贝过来的代码
     * 因为在启动阶段，ExceptionUtils还不可用
     *
     * @param t
     */
